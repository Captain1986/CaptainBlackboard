...
![3rd_lib.h](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-30-03.png)

![3rd_lib.cpp](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-31-42.png)

第三方库很简单，就是在_3rd_lib_func()这个函数里面调了printf()打印了一句话。

接着是main.cpp代码，在main函数里面调用了第三方库里面的_3rd_lib_func()，自己也调用了printf打印了一句话。

![main.cpp](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-36-09.png)

最后是我们最重要的，劫持了库里面的int puts ( const char * str )的函数：

![my_hack.h](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-39-19.png)

![my_hack.cpp](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-40-08.png)

这个my_hack.cpp就是改写了系统默认的puts函数，而**puts函数是printf到系统内核调用链条中的一环**，所以，我们在自己写的puts函数里面，就可以为所欲为了。实验过程如下：

![hack](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 20-55-24.png)
...
![main2.cpp](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 21-18-07.png)
...
![](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 21-22-58.png)
...
![](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 21-56-03.png)
...
![replace.cpp](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 22-01-50.png)

实验结果如下：

![](https://github.com/Captain1986/CaptainBlackboard/tree/master/D%230002-hack_your_printf/images/Screenshot from 2019-01-31 22-09-21.png)
