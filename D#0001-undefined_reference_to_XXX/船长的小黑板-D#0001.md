...
![](/home/dup/Desktop/Selection_175.png)
...
![](/home/dup/Desktop/Selection_176.png)

+ 1.2 缺目标文件。同样，首先把foo.cpp编译成目标文件foo.o之后，也可以用foo.o来编译，也可以解决"undefined reference to XXX"的问题：

![](/home/dup/Desktop/Selection_177.png)

+ １.3 缺库文件。最后，把foo.cpp编译成动态库（静态库一样的）文件foo.so，我们来试试：

![](/home/dup/Desktop/Selection_178.png)

### Case 2, 链接顺序不对

接上节1.3，请看下面的代码：![](/home/dup/Desktop/Selection_179.png)
...
![](/home/dup/Desktop/Selection_180.png)

在bar.h文件内bar函数的声明是void bar(void)，在实现文件内实现是void bar(int)，参数列表变了。

编译一下：

![](/home/dup/Desktop/Selection_181.png)
...
![](/home/dup/Desktop/Selection_182.png)

先用gcc编译C文件baz.c得到目标文件baz.o，然后用g++编译C++文件main.cpp和baz.o，就出现了错误：

![](/home/dup/Desktop/Selection_184.png)

解决方案，加上extern "C"，就可以了：

![](/home/dup/Desktop/Selection_185.png)
...
+ 怎么查看动态库文件里面提供了哪些函数符号？
  ...
  ![](/home/dup/Desktop/Selection_186.png)

  要查看bar.so这个库里面提供了哪些函数符号，可以用nm命令

  ![](/home/dup/Desktop/Selection_187.png)
...
+ 知道了函数修饰后的名字，怎么推函数声明？
  ...
  ![](/home/dup/Desktop/Selection_188.png)
