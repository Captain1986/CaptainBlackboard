...
![](https://github.com/Captain1986/CaptainBlackboard/blob/master/D%230003-optimizing_cosine_distance_searching_in_a_million_feature-set/images/Selection_210.png)

然后把Cosine_similarity函数里面计算两向量模的代码注释掉：

![](https://github.com/Captain1986/CaptainBlackboard/blob/master/D%230003-optimizing_cosine_distance_searching_in_a_million_feature-set/images/Selection_211.png)

测试一下：

![](https://github.com/Captain1986/CaptainBlackboard/blob/master/D%230003-optimizing_cosine_distance_searching_in_a_million_feature-set/images/Selection_212.png)
...
### Step 11，特征选择
特征向量里面有512维的特征，但是这512维特征的重要性不一定都是一样的，如果我们能有选择性地抽取里面信息量最大的特征，减少特征向量的维数，那么我们就减少了计算量，**更重要的是，加大了内存访问数据量**，增加了CPU的利用率。[PCA](https://en.wikipedia.org/wiki/Principal_component_analysis)就是一种在减少数据集的维度的同时，保持对方差贡献最大(信息量保持最多)的特征的特征选择压缩算法。
因为我们在这里不是探讨PCA算法的过程，我们就直接假设512维的特征向量压缩到了256维。
改动如下：
...
![](https://github.com/Captain1986/CaptainBlackboard/blob/master/D%230003-optimizing_cosine_distance_searching_in_a_million_feature-set/images/Selection_226.png)

实验过程结果如下：

![](https://github.com/Captain1986/CaptainBlackboard/blob/master/D%230003-optimizing_cosine_distance_searching_in_a_million_feature-set/images/Selection_227.png)
...
先做一点理论分析：
（1）在我的电脑上,sizeof(float)等于4，sizeof(short)等于2，如果用unsigned short代替float，内存读取效率可以提升2倍。
...
+ [左庆误差分析](https://zhuanlan.zhihu.com/p/35904005)
+ [Why GEMM is at the heart of deep learning](https://petewarden.com/2015/04/20/why-gemm-is-at-the-heart-of-deep-learning/)
+ [OpenBLAS gemm 入门和分析](https://www.jianshu.com/p/26f24f464016)
+ [浮点峰值那些事儿](https://zhuanlan.zhihu.com/p/28226956)
+ [探求计算性能的极限](https://wenku.baidu.com/view/788ba23dfc4ffe473268ab07.html)
